        ...
        <div className="mt-14 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
          {[...Array(6)].map((_, index) => (
            <div
              ...
              className="overflow-hidden rounded-2xl border border-primary/15 bg-[#111]"
            >
              <div className="h-52 w-full animate-pulse bg-[#1a1a1a]" />
              <div className="p-5">
                <div className="h-5 w-2/3 animate-pulse rounded bg-[#1a1a1a]" />
                <div className="mt-3 h-3 w-full animate-pulse rounded bg-[#1a1a1a]" />
                <div className="mt-2 h-3 w-3/4 animate-pulse rounded bg-[#1a1a1a]" />

...
export interface ApiFleetPageFleetPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Content for the fleet listing page';
    displayName: '/fleet';
    pluralName: 'fleet-pages';
    singularName: 'fleet-page';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiFleetFleet extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Chauffeur vehicle fleet';
    displayName: 'Fleet';
    pluralName: 'fleets';
    singularName: 'fleet';
  };
  ...
  attributes: {
    amenities: Schema.Attribute.Component<'shared.perks', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    luggage_capacity: Schema.Attribute.Integer;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    allowAiCrawlers: Schema.Attribute.Boolean &
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultRobots: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }> &
      Schema.Attribute.DefaultTo<'index,follow,max-image-preview:large'>;
    defaultSocialImage: Schema.Attribute.Media<'images'>;
    facebookDomainVerification: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    llmsTxt: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    robotsDisallowPaths: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    themeColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#06b6d4'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    xHandle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    yandexVerification: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Chauffeur transfer service offerings';
  ...
  attributes: {
    ...
    fleets: Schema.Attribute.Relation<'manyToMany', 'api::fleet.fleet'>;
    ...
    service_points: Schema.Attribute.Component<'shared.steps', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiServicesPageServicesPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Content for the services listing page';
    displayName: '/services';
...
export interface ApiTransferTransfer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Transfer destination pages with booking widget and SEO content';
  ...
  attributes: {
    booking_form_embed_html: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    mini_hero_title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTransfersPageTransfersPage extends Struct.SingleTypeSchema {
  collectionName: 'transfers_pages';
  info: {
    description: 'Content for the transfers listing page';
    displayName: '/transfers';
